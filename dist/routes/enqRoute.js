...
router.post("/", authMiddleware_1.authMiddleware, enqCtrl_1.createEnquiry);
...
router.get("/", authMiddleware_1.authMiddleware, authMiddleware_1.isAdmin, enqCtrl_1.getallEnquiry);
